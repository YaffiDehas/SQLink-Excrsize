...
const filterStore = (state = initialState, action) => {
  switch (action.type) {
    ...
    case SORT_BY_ALPHABET:
      ...
      let sortedAlphabetArr =
        action.payload.direction === "asc"
          ? sortAsc(state.filteredProjects, "name")
          : sortDesc(state.filteredProjects, "name");

      sortByAlphabetState.filteredProjects = sortedAlphabetArr;
    ...
    case SORT_BY_SCORE:
      ...
      let sortedPriceArr =
        action.payload.direction === "asc"
          ? sortAsc(state.filteredProjects, "score")
          : sortDesc(state.filteredProjects, "score");

      sortByPriceState.filteredProjects = sortedPriceArr;
    ...
    case FILTER_BY_VALUE:
      ...
      if (value) {
        ...
        newState.filteredProjects = filteredValues;
    ...
    case LOAD_NEW_PAGE:
      ...
      loadNewPageState.filteredProjects = nextProducts;
    ...
    case LOAD_EXACT_PAGE:
      ...
      exactPageState.filteredProjects = exactProducts;
